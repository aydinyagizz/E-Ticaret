...
if ($urunsor->rowCount()==0) {
	header("Location:index.php?durum=bulunamadı");
	exit;
}
		...
		<div class="col-md-9"><!--Main content-->
			...
			<div class="row">
				<div class="col-md-6">
					...
					$urun_id=$uruncek['urun_id'];
					$urunfotosor=$db->prepare("SELECT * FROM urunfoto where urun_id=:urun_id order by urunfoto_sira ASC limit 1,3"); /*sorguda 1,3 'ün anlamı; 1.kayıttan sonra 3 tane kayıt getir anlamında.*/
					$urunfotosor->execute(array(
						'urun_id' => $urun_id
					));
					...
					<div class="productdata">
						...
						<form action="nedmin/netting/islem.php" method="POST">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="tetx" class="form-control" value="1" name="urun_adet">
								</div>
					...
					<div class="tab-pane fade <?php if ($_GET['durum']=="ok") {?>
						...
						<?php if (isset($_SESSION['userkullanici_mail'])) { ?>
							...
							<form action="nedmin/netting/islem.php" method="POST" role="form">
								...
								<input type="hidden" name="gelen_url" value="<?php echo "http://".$_SERVER['HTTP_HOST']."".$_SERVER['REQUEST_URI'].""; ?>">  <!-- value değerinde adres satırını alıyoruz -->
						...
						<?php  } else { ?>
							...
							Yorum Yazabilmeniz İçin <a style="color: red" href="register.php">Kayıt</a> Olmalı yada Üyemizseniz Giriş Yapmalısınız.
