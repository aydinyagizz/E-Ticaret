...
if (isset($_POST['kullanicikaydet'])) {
	...
	$kullanici_adsoyad=htmlspecialchars($_POST['kullanici_adsoyad']);/*htmlspecialchars; gönderilen postlar içindeki zararlı kodları temizler.*/  /*strip_tags; ise script kodlarını temizlemeye yarar. script kelimelerini koddan çıkarır.*/
...
if ($_GET['slidersil']=="ok") {
	...
	islemkontrol(); /*yazdığımız fonksiyon sayfasındaki fonksiyonu çağırıyoruz. kullanıcının izni var mı yok mu kontrol ediyoruz. menü sil gibi yerlerde kullanmadım ama oralarda kullanılacak güvenlik önlemidir.*/
...
if (isset($_POST['sliderduzenle'])) {
	...
	if($_FILES['slider_resimyol']["size"] > 0)  { /*resim var mı yok mu koşulu*/
...
if (isset($_POST['logoduzenle'])) {
	...
	if ($_FILES['ayar_logo']['size']>1048576)  /*1 megabayt'tan büyük dosyaları kabul etmiyoruz.*/ {
...
if (isset($_POST['genelayarkaydet'])) {  /*isset bir değişkenin dolu olup olmadığını denetler.*/
	...
	/*sorgu işlemleri*/
	if ($update) {
		header("Location:../production/genel-ayar.php?durum=ok");  /*yönlendirme işlemi yapar. bu işlem sağlandığında istediğiniz sayfaya dönüş yaparsınız.*/
	}
	else{
		header("Location:../production/genel-ayar.php?durum=no");
	}
...
if (isset($_POST['iletisimayarkaydet'])) {  /*isset bir değişkenin dolu olup olmadığını denetler.*/
	...
	/*sorgu işlemleri*/
	if ($update) {
		header("Location:../production/iletisim-ayarlar.php?durum=ok");  /*yönlendirme işlemi yapar. bu işlem sağlandığında istediğiniz sayfaya dönüş yaparsınız.*/
	}
	else{
...
if (isset($_POST['apiayarkaydet'])) {  /*isset bir değişkenin dolu olup olmadığını denetler.*/
	...
	/*sorgu işlemleri*/
	if ($update) {
		header("Location:../production/api-ayarlar.php?durum=ok");  /*yönlendirme işlemi yapar. bu işlem sağlandığında istediğiniz sayfaya dönüş yaparsınız.*/
	}
	else{
...
if (isset($_POST['sosyalayarkaydet'])) {  /*isset bir değişkenin dolu olup olmadığını denetler.*/
	...
	/*sorgu işlemleri*/
	if ($update) {
		header("Location:../production/sosyal-ayarlar.php?durum=ok");  /*yönlendirme işlemi yapar. bu işlem sağlandığında istediğiniz sayfaya dönüş yaparsınız.*/
	}
	else{
...
if (isset($_POST['mailayarkaydet'])) {  /*isset bir değişkenin dolu olup olmadığını denetler.*/
	...
	/*sorgu işlemleri*/
	if ($update) {
		header("Location:../production/mail-ayarlar.php?durum=ok");  /*yönlendirme işlemi yapar. bu işlem sağlandığında istediğiniz sayfaya dönüş yaparsınız.*/
	}
	else{
...
if (isset($_POST['hakkimizdakaydet'])) {  /*isset bir değişkenin dolu olup olmadığını denetler.*/
	
	/*Tablo güncelleme işleri kodları */

	/* copy paste işlemlerinden tablo ve işaretli satır isminin değiştirildiğinden emin olmak lazım. */
	...
	/*sorgu işlemleri*/
	if ($update) {
		header("Location:../production/hakkimizda.php?durum=ok");  /*yönlendirme işlemi yapar. bu işlem sağlandığında istediğiniz sayfaya dönüş yaparsınız.*/
	}
	else{
...
if (isset($_POST['yorumkaydet'])) {
	...
	if ($insert) {
		header("Location:$gelen_url?durum=ok"); /*urun-detay sayfasında gelen_url ile sayfaya url ile geri dönme oluşturduk .*/
	}
	else {
